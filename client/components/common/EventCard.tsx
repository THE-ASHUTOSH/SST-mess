...
const EventCard:React.FC<CardProps> = ({title,description,logoUrl,children,redirectUrl}:CardProps) => {
  return (
    ...
    <Card className="w-full h-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-purple-500/20 transform hover:-translate-y-2 transition-all duration-300 group" >
